...
private int findKeyword(String statement, String goal)
{
	...
	public String getResponse(String statement)
	{
        ...
        //---pets---
				...
				|| findKeyword(statement, "alligator") >= 0)
		{
			response = "Tell me more about your pets.";
		}

        //---Teacher---
        else if((statement.indexOf("Adiletta") != -1) || (statement.indexOf("Mr. A") != -1)) {
            response = "sounds like this Mr. A character knows what's up.";    
        }
		...
		//---I like something---
			...
			//cut the substring of the thing you like
			String thing = statement.substring(pos + "I like".length()).trim();
